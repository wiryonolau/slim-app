...
return [
    'service' => [
        'factories' => [
            ...
            Translator\Translator::class => Translator\Factory\TranslatorFactory::class,
            Translator\LocaleMiddleware::class => Translator\Factory\LocaleMiddlewareFactory::class,
    ...
    'view_helpers' => [
        'aliases' => [
            ...
            't' => Translator\View\Helper\TranslateViewHelper::class,
            'ts' => Translator\View\Helper\TranslatePluralViewHelper::class,
